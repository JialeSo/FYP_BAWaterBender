#!/usr/bin/env python3
"""
Step 00: Clean Amenities Data Consolidation
============================================

Consolidates all amenity sources and maps to amenities_3layers.csv structure.

Target Structure (from amenities_3layers.csv):
----------------------------------------------
- amenity_id: UUID
- amenity_type: Type/category (e.g., bus_depots, childcare_clean)
- amenity_name: Name of the amenity
- road_name: Road name
- postal_code: Postal code
- geom_type: Geometry type (Point, Polygon, etc.)
- lon: Longitude
- lat: Latitude
...
def map_geojson_to_standard(feature: Dict, source_file: str) -> Dict:
    """
    Map GeoJSON feature to standard amenities_3layers.csv structure.
...
def main():
    """Run consolidation."""
    print("\n" + "="*80)
    print("STEP 00: AMENITIES DATA CONSOLIDATION (CLEAN)")
    print("="*80)
