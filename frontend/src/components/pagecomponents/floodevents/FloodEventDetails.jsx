...
export function FloodEventDetails({
  ...
  const arImpactLabel = "Top 10%";
  const amenitiesLabel = "Top 50%";
  const roadsLabel = "Top 10%";
      ...
      <ScrollArea className="flex-1" style={{ height: "calc(36rem - 0px)" }}>
        <div className="p-3 space-y-3">
          ...
          <div className="flex items-center justify-between border-b border-border/60 pb-2">
            <div>
              <h3 className="text-base font-semibold">Flood Event Details</h3>
              <p className="text-xs text-muted-foreground">
          ...
          <div className="grid grid-cols-3 gap-3">
            {/* AR Impact */}
            <div className="rounded-2xl border border-primary/40 bg-gradient-to-br from-primary/15 via-background/40 to-background px-4 py-3 space-y-2">
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs uppercase tracking-wide text-muted-foreground">
                  AR Impact
                </span>
                <span className="inline-flex items-center rounded-full bg-primary/25 px-2 py-0.5 text-xs font-medium">
                  {arImpactLabel}
                </span>
              </div>
            ...
            {/* Amenities */}
            <div className="rounded-2xl border border-orange-500/40 bg-gradient-to-br from-orange-500/15 via-background/40 to-background px-4 py-3 space-y-2">
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs uppercase tracking-wide text-muted-foreground">
                  Amenities
                </span>
                <span className="inline-flex items-center rounded-full bg-orange-500/25 px-2 py-0.5 text-xs font-medium text-orange-100">
                  {amenitiesLabel}
                </span>
              </div>
            ...
            {/* Roads */}
            <div className="rounded-2xl border border-blue-500/40 bg-gradient-to-br from-blue-500/15 via-background/40 to-background px-4 py-3 space-y-2">
              <div className="flex items-center justify-between gap-2">
                <span className="text-xs uppercase tracking-wide text-muted-foreground">
                  Roads
                </span>
                <span className="inline-flex items-center rounded-full bg-blue-500/25 px-2 py-0.5 text-xs font-medium text-blue-100">
                  {roadsLabel}
                </span>
              </div>
            ...
            <div className="px-4 py-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-6 text-sm">
                ...
                <div className="col-span-2">
                  ...
                  <div
                    className="truncate"
                    title={selected_props?.parent_road}
                  >
          ...
          <Card className="rounded-2xl border border-border/70 bg-background/80">
            <div className="px-4 py-3 space-y-3">
              ...
              >
                ...
                {/* Amenities */}
                <TabsContent value="amenities" className="mt-2 space-y-2">
                  {(() => {
                            ...
                            <div className="space-y-1.5 pr-1">
                              {filteredAmenities.map((amenity, idx) => {
                                ...
                                return (
                                  <div
                                    key={`${amenity.id}-${idx}`}
                                    className="flex items-center justify-between text-xs rounded-lg px-3 py-2 bg-muted/30 hover:bg-muted transition-colors"
                                  >
                                    ...
                                    <Button
                                      ...
                                      className="h-7 px-2 text-xs hover:bg-primary/10 ml-1 shrink-0 rounded-full"
                                    >
                                      Focus
                                    </Button>
                                  </div>
                ...
                {/* Roads */}
                <TabsContent value="roads" className="mt-2 space-y-2">
                  {(() => {
                    const allRoads = [];
                    if (inner_enabled) {
